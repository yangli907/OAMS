<cfcomponent output="false">
	...
	<cffunction name="create" output="false" access="public">
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="framework">
				insert into users(first, last, email, phone, dept, loc, grp, pass, admin, sgrp, sgadmin)
				values (
	...
	<cffunction name="update" output="false" access="public">
        ...
        <cfquery name="qUpdate1" datasource="framework" result="status">
			select pass
            from users
		...
		<cfquery name="qUpdate2" datasource="framework" result="status">
			update users
